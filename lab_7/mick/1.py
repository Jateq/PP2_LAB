...
right = pygame.transform.scale(pygame.image.load('img\\right.png'), (594 // 2, 322 // 2))
left = pygame.transform.scale(pygame.image.load('img\\left.png'), (770 // 2, 230 // 2))
...
while True:
    ...
    blitRotate(screen, right, center, (right.get_width() / 2 + 110, right.get_height() / 2 + 75), theta + 75)
